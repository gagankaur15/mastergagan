  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
		...
		<h4 class="section-heading">Latest news <span class="pull-right"><a href="https://twitter.com/TGLGuidelines" target="_blank"><img src="<?php echo WP_CONTENT_DIR_NAME; ?>/uploads/twitter_logo.png" alt="Twitter"></a> <a href="https://www.linkedin.com/company/therapeutic-guidelines-limited" target="_blank"><img src="<?php echo WP_CONTENT_DIR_NAME; ?>/uploads/linkedin_logo.png" alt="Linkedin"></a> 	</span></h4>
		<?php
		 // WP_Query arguments
			$args = array (
				'post_type'              => 'news',
