    ...
    class TGM_Plugin_Activation {
        ...
        public function admin_init() {
            ...
            if ( isset( $_REQUEST['tab'] ) && 'plugin-information' === $_REQUEST['tab'] ) {
                require_once ABSPATH . WP_ADMIN_DIR_NAME.'/includes/plugin-install.php'; // Need for install_plugin_information().
        ...
        protected function do_plugin_install() {
            ...
            if ( isset( $_GET['plugin'] ) && ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' === $_GET['tgmpa-install'] ) ) {
                ...
                require_once ABSPATH . WP_ADMIN_DIR_NAME.'/includes/plugin-install.php'; // Need for plugins_api.
                require_once ABSPATH . WP_ADMIN_DIR_NAME.'/includes/class-wp-upgrader.php'; // Need for upgrade classes.
...
if ( ! function_exists( 'tgmpa_load_bulk_installer' ) ) {
    function tgmpa_load_bulk_installer() {
        ...
        if ( ! class_exists( 'WP_Upgrader' ) && ( isset( $_GET['page'] ) && $tgmpa_instance->menu === $_GET['page'] ) ) {
            require_once ABSPATH . WP_ADMIN_DIR_NAME.'/includes/class-wp-upgrader.php';
