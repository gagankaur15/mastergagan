...
class AIOWPSecurity_Utility_File
{
    ...
    function __construct(){
        ...
        $this->files_and_dirs_to_check = array(
            ...
            array('name'=>WP_INCLUDE_DIR_NAME.'/','path'=>ABSPATH.WP_INCLUDE_DIR_NAME,'permissions'=>'0755'),
            array('name'=>'.htaccess','path'=>ABSPATH.".htaccess",'permissions'=>'0644'),
            array('name'=>WP_ADMIN_DIR_NAME.'/index.php','path'=>ABSPATH.WP_ADMIN_DIR_NAME."/index.php",'permissions'=>'0644'),
            array('name'=>WP_ADMIN_DIR_NAME.'/js/','path'=>ABSPATH.WP_ADMIN_DIR_NAME."/js/",'permissions'=>'0755'),
            array('name'=>WP_CONTENT_DIR_NAME.'/themes/','path'=>ABSPATH.WP_CONTENT_DIR_NAME."/themes",'permissions'=>'0755'),
            array('name'=>WP_CONTENT_DIR_NAME.'/plugins/','path'=>ABSPATH.WP_CONTENT_DIR_NAME."/plugins",'permissions'=>'0755'),
            array('name'=>WP_ADMIN_DIR_NAME.'/','path'=>ABSPATH.WP_ADMIN_DIR_NAME,'permissions'=>'0755'),
            array('name'=>WP_CONTENT_DIR_NAME.'/','path'=>ABSPATH.WP_CONTENT_DIR_NAME,'permissions'=>'0755'),
