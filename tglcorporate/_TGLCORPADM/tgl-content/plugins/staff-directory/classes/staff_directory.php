...
class StaffDirectory {
  ...
  static function create_post_types() {
	  $labels = array(
		'name'                  => _x( 'Board of Directors', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Borad of Director', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Board of Directors', 'text_domain' ),
		'name_admin_bar'        => __( 'Borad of Director', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'Borad of Director', 'text_domain' ),
  ...
  static function staff_meta_box_output( $post ) {
	...
	<p>
	 <label for="menu_order" class="staff-label">Menu Order:</label>
