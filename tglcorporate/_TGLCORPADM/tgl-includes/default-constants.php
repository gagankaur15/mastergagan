...
function wp_initial_constants() {
	...
	if ( !defined('WP_CONTENT_DIR') )
		define( 'WP_CONTENT_DIR', str_replace('_TGLCORPADM', 'TGLCorporate_WEB', ABSPATH)  . WP_CONTENT_DIR_NAME ); // no trailing slash, full paths only - WP_CONTENT_URL is defined further down
...
function wp_plugin_directory_constants() {
	if ( !defined('WP_CONTENT_URL') )
		define( 'WP_CONTENT_URL', get_option('siteurl') . '/'.WP_CONTENT_DIR_NAME); // full url - WP_CONTENT_DIR is defined further up
...
function wp_cookie_constants() {
	...
	if ( !defined('ADMIN_COOKIE_PATH') )
		define( 'ADMIN_COOKIE_PATH', SITECOOKIEPATH . WP_ADMIN_DIR_NAME );
