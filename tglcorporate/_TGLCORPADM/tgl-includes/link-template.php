...
function get_shortcut_link() {
	...
	include_once( ABSPATH . WP_ADMIN_DIR_NAME.'/includes/class-wp-press-this.php' );
	...
	if ( empty( $link ) ) {
		$src = @file_get_contents( ABSPATH . WP_ADMIN_DIR_NAME.'/js/bookmarklet.min.js' );
...
function get_admin_url( $blog_id = null, $path = '', $scheme = 'admin' ) {
	$url = get_site_url($blog_id, WP_ADMIN_DIR_NAME.'/', $scheme);
...
function network_admin_url( $path = '', $scheme = 'admin' ) {
	...
	$url = network_site_url(WP_ADMIN_DIR_NAME.'/network/', $scheme);
...
function user_admin_url( $path = '', $scheme = 'admin' ) {
	$url = network_site_url(WP_ADMIN_DIR_NAME.'/user/', $scheme);
