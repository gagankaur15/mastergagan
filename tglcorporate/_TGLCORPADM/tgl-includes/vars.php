...
if ( is_admin() ) {
	...
	if ( is_network_admin() )
		preg_match('#/'.WP_ADMIN_DIR_NAME.'/network/?(.*?)$#i', $_SERVER['PHP_SELF'], $self_matches);
	elseif ( is_user_admin() )
		preg_match('#/'.WP_ADMIN_DIR_NAME.'/user/?(.*?)$#i', $_SERVER['PHP_SELF'], $self_matches);
	else
		preg_match('#/'.WP_ADMIN_DIR_NAME.'/?(.*?)$#i', $_SERVER['PHP_SELF'], $self_matches);
