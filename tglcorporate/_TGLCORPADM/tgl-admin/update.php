...
if ( isset($_GET['action']) ) {
	...
	if ( 'update-selected' == $action ) {
		...
		include_once( ABSPATH . WP_ADMIN_DIR_NAME.'/includes/plugin-install.php' ); //for plugins_api..
		...
		include_once( ABSPATH . WP_ADMIN_DIR_NAME.'/includes/class-wp-upgrader.php' ); //for themes_api..
