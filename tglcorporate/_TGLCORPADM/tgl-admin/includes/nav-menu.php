...
require_once( ABSPATH . WP_ADMIN_DIR_NAME.'/includes/class-walker-nav-menu-edit.php' );

/** Walker_Nav_Menu_Checklist class */
require_once( ABSPATH . WP_ADMIN_DIR_NAME.'/includes/class-walker-nav-menu-checklist.php' );
