...
require_once( ABSPATH . WP_ADMIN_DIR_NAME.'/includes/class-walker-category-checklist.php' );

/** WP_Internal_Pointers class */
require_once( ABSPATH . WP_ADMIN_DIR_NAME.'/includes/class-wp-internal-pointers.php' );
