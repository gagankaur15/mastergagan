...
class Core_Upgrader extends WP_Upgrader {
	...
	public function upgrade( $current, $args = array() ) {
		...
		if ( !$wp_filesystem->copy($working_dir . '/wordpress/'.WP_ADMIN_DIR_NAME.'/includes/update-core.php', $wp_dir . WP_ADMIN_DIR_NAME.'/includes/update-core.php', true) ) {
			$wp_filesystem->delete($working_dir, true);
			WP_Upgrader::release_lock( 'core_updater' );
			return new WP_Error( 'copy_failed_for_update_core_file', __( 'The update cannot be installed because we will be unable to copy some files. This is usually due to inconsistent file permissions.' ), WP_ADMIN_DIR_NAME.'/includes/update-core.php' );
		}
		$wp_filesystem->chmod($wp_dir . WP_ADMIN_DIR_NAME.'/includes/update-core.php', FS_CHMOD_FILE);

		require_once( ABSPATH . WP_ADMIN_DIR_NAME.'/includes/update-core.php' );
