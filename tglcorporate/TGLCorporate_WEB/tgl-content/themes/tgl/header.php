...
<!--<![endif]-->
<head>
	<meta http-equiv='Content-Security-Policy' content="default-src 'self' 'unsafe-eval' 'unsafe-inline' cdn.datatables.net *.tg.org.au www.google-analytics.com ajax.googleapis.com *.googletagmanager.com fonts.googleapis.com netdna.bootstrapcdn.com fonts.gstatic.com cdn.ckeditor.com code.jquery.com *.hotjar.com cdnjs.cloudflare.com *.gstatic.com *.macromedia.com *.adobe.com *.youtube.com *.google.com i.imgur.com *.wa.gov.au i.ytimg.com *.edu.au *.gravatar.com cdn.jsdelivr.net *.mpstechnologies.com *.oclc.org *.silverchain.idm.oclc.org data *.ajax.googleapis.com *.googletagmanager.com ;
script-src 'self' 'unsafe-eval' 'unsafe-inline' cdn.datatables.net *.tg.org.au *.google-analytics.com ajax.googleapis.com *.googletagmanager.com fonts.googleapis.com netdna.bootstrapcdn.com fonts.gstatic.com cdn.ckeditor.com code.jquery.com cdnjs.cloudflare.com *.gstatic.com *.macromedia.com *.adobe.com *.youtube.com *.google.com i.imgur.com *.wa.gov.au i.ytimg.com *.edu.au *.gravatar.com cdn.jsdelivr.net *.mpstechnologies.com *.oclc.org *.silverchain.idm.oclc.org data *.ajax.googleapis.com *.googletagmanager.com *.hotjar.com; 
 style-src 'self' 'unsafe-eval' 'unsafe-inline' cdn.datatables.net *.tg.org.au *.google-analytics.com ajax.googleapis.com *.googletagmanager.com fonts.googleapis.com netdna.bootstrapcdn.com fonts.gstatic.com cdn.ckeditor.com code.jquery.com cdnjs.cloudflare.com *.gstatic.com *.macromedia.com *.adobe.com *.youtube.com *.google.com i.imgur.com *.wa.gov.au i.ytimg.com *.edu.au *.gravatar.com cdn.jsdelivr.net *.mpstechnologies.com *.oclc.org *.silverchain.idm.oclc.org data *.ajax.googleapis.com *.googletagmanager.com; 
 img-src 'self' 'unsafe-eval' 'unsafe-inline' cdn.datatables.net *.tg.org.au *.google-analytics.com ajax.googleapis.com *.googletagmanager.com fonts.googleapis.com netdna.bootstrapcdn.com fonts.gstatic.com cdn.ckeditor.com code.jquery.com cdnjs.cloudflare.com *.gstatic.com *.macromedia.com *.adobe.com *.youtube.com *.hotjar.com *.google.com i.imgur.com *.wa.gov.au i.ytimg.com *.edu.au *.gravatar.com cdn.jsdelivr.net *.mpstechnologies.com *.oclc.org *.silverchain.idm.oclc.org data *.ajax.googleapis.com *.googletagmanager.com"/>
...
<!-- Google Tag Manager for tg.org.au -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-M5GRJM"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-M5GRJM');</script>
...
<svg width="127" height="39">
            <image xlink:href="<?php echo get_template_directory_uri(); ?>/images/svgassets/tgl_logo.svg" src="<?php echo get_template_directory_uri(); ?>/images/tglLogo.png" width="127" height="39" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>"/>
            </svg>
</a>
		</div> 
...
<?php 
$fullname = $_SESSION["cdplogin"]['given_name'].' '.$_SESSION["cdplogin"]['surname'];
$link = true;
if(isset($_SESSION["cdplogin"]["parent"]) && $_SESSION["cdplogin"]["parent"] != $_SESSION["cdplogin"]["id"] ){
	$link = false;
}

if($_SESSION["cdplogin"]["multiUser"] == 'yes' || ($_SESSION["cdplogin"]["multiUser"] == 'no' && isset($_SESSION["cdplogin"]["parent"]) && $_SESSION["cdplogin"]["parent"] != '') ){
	$fullname = !empty($_SESSION["cdplogin"]['businessname'])?$_SESSION["cdplogin"]['businessname']:$fullname;
}
             ...
             <div class="dropdown" id="etg-compXsDropdown">
              <span class="fa fa-ellipsis-v fa-2x pull-right dropdown-toggle" id="dropdownMenu2" data-toggle="dropdown" aria-expanded="true"></span> <!--icon-ellipsis-vertical -->   
                  <ul class="dropdown-menu" id="purchaseLicence" role="menu" aria-labelledby="dropdownMenu2">
                    <li role="presentation"><a href="<?php echo ($link == true)?TGL_DELIVERY_URL.'/showMyProfile':'javascript:' ?>"><strong><?php echo $fullname ; ?></strong></a></li>
...
<?php } ?>		
 ...
 <?php if(isset($_SESSION["cdplogin"])){
	...
	<ul class="dropdown-menu dropdown-menu-right" id="purchaseLicence" role="menu" aria-labelledby="dropdownMenu1">
	  <li role="presentation"><a href="<?php echo ($link == true)?TGL_DELIVERY_URL.'/showMyProfile':'javascript:' ?>" tabindex="-1" role="menuitem"><strong><?php echo $fullname; ?></strong></a></li>
	  <?php if($_SESSION["cdplogin"]['subscription'] == 'etgcomplete') { ?> 
	  <li role="presentation"><a href="<?php echo TGL_DELIVERY_URL; ?>/etgAccess" tabindex="-1" role="menuitem">eTG complete online</a></li>
	  <?php } ?>
	  <li class="divider"></li>
	...
	<?php 
         ...
         <a data-target="#loginBox" data-backdrop="static" data-keyboard="false" data-toggle="modal" href="#" id="loginButton" class="btn btn-info btn-block" title="Log in">Log in</a>
         <!-- <a  href="<?php echo TGL_DELIVERY_URL.'/etgAccess'; ?>" id="loginButton1" class="btn btn-info btn-block" title="eTG complete">eTG complete</a>  -->
     </div>
	<?php } ?>		 
        </div>        
        </div>
              ...
              <form id="searchfrm" method="post" action="<?php echo TGL_DELIVERY_URL; ?>/searchAction">
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
					  ...
					  <div class="col-lg-6 col-sm-8 noRPaddingIP">
						...
						<a href="#" title="eTG complete Log in" class="btn btn-info btn-block" data-target="#loginBox" data-backdrop="static" data-keyboard="false" data-toggle="modal">Log in</a> 
						<!-- <a  href="<?php echo TGL_DELIVERY_URL.'/etgAccess'; ?>" id="loginButton1" class="btn btn-info btn-block" title="eTG complete">eTG complete</a>  -->
					</div>
						<?php } ?>
 <?php
                                wp_nav_menu(array('theme_location' => 'primary', 'menu_class' => 'sf-menu sidebar-offcanvas col-lg-10', 'menu_id' => 'sidebar'));
                                ?><?php
                                //wp_nav_menu( array( 
                                  //'items_wrap' => '<ul id="%1$s" class="%2$s"><div class="mobnav-subarrow"><i class="flaticon-downarrow25 blk_xs"></i></div>%3$s </ul>','theme_location' => 'primary', 'menu_class' => 'sf-menu sidebar-offcanvas col-lg-10','menu_id' => 'sidebar'
                                 // ) ); 
                                ?>
     ...
     <div class="input-group search-widget">
      <?php $search =  get_query_var( 's' ); ?>
        <input type="text" id="search_input" name="appendedInputButtons" value="Search eTG complete" onfocus="if(this.value === 'Search eTG complete') this.value = '';" onblur="if(this.value === '') this.value = 'Search eTG complete';" class="form-control typeahead" style="padding: 4px 12px;" data-provide="typeahead" autocomplete="off" placeholder="">
...
jQuery(document).ready(function(){
 ...
 <div class="clearfix"></div>
		  ...
		  <div class="container">
			<div class="row">			    
			  <ul class="breadcrumb">
				<li><?php if(!is_front_page() and function_exists('bcn_display'))
				{
					bcn_display();
				}?></li>
			  </ul>
