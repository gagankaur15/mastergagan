...
function list_plugin_updates() {
	...
	require_once(ABSPATH . WP_ADMIN_DIR_NAME.'/includes/plugin-install.php');
...
if ( 'upgrade-core' == $action ) {
	...
	require_once(ABSPATH . WP_ADMIN_DIR_NAME.'/admin-header.php');
	?>
	<div class="wrap">
	...
	require_once( ABSPATH . WP_ADMIN_DIR_NAME.'/admin-footer.php' );
