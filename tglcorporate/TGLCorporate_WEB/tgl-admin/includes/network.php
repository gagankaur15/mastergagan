        ...
        <rewrite>
            <rules>
                ...
                <rule name="WordPress Rule 2" stopProcessing="true">
                    <match url="^' . $iis_subdir_match . WP_ADMIN_DIR_NAME.'$" ignoreCase="false" />
                    <action type="Redirect" url="' . $iis_subdir_replacement . WP_ADMIN_DIR_NAME.'/" redirectType="Permanent" />
                </rule>
...
';
	...
	<?php else : // end iis7_supports_permalinks(). construct an htaccess file instead:
		...
		$admin_new_url=WP_ADMIN_DIR_NAME;
		$htaccess_file = <<<EOF
RewriteEngine On
RewriteBase {$base}
RewriteRule ^index\.php$ - [L]
{$ms_files_rewriting}
# add a trailing slash to /{$admin_new_url}
RewriteRule ^{$subdir_match}{$admin_new_url}$ {$subdir_replacement_01}{$admin_new_url}/ [R=301,L]
