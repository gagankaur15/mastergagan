...
require_once( ABSPATH . WP_ADMIN_DIR_NAME.'/includes/translation-install.php' );
...
include( ABSPATH . WP_ADMIN_DIR_NAME.'/admin-header.php' );
...
<?php include( ABSPATH . WP_ADMIN_DIR_NAME.'/admin-footer.php' ); ?>
